    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
            <motion.div
                ...
                className="bg-white dark:bg-slate-900 rounded-t-3xl sm:rounded-3xl shadow-2xl w-full max-w-4xl max-h-[85dvh] flex flex-col md:flex-row overflow-hidden border-t sm:border border-slate-200 dark:border-slate-700"
            >
                {/* Image Section */}
