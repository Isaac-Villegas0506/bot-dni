    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <motion.div
                ...
                className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl max-w-sm w-full p-4 sm:p-5 border-2 border-slate-200 dark:border-slate-700 max-h-[85dvh] overflow-y-auto"
            >
