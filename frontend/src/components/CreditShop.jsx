        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-md" onClick={onClose}>
            {qrZoom && (
                <div className="fixed inset-0 z-[210] flex items-center justify-center bg-slate-950/90 p-4" onClick={() => setQrZoom(false)}>
                    <img src={`/payments/${method}/${method}-qr.png`} alt="QR" className="max-w-full max-h-[85vh] object-contain rounded-xl" />
                </div>
            )}
            ...
            <motion.div
                ...
                onClick={e => e.stopPropagation()}
                className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] border border-slate-200 dark:border-slate-800"
            >
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm" onClick={onClose}>
            <motion.div
                ...
                onClick={e => e.stopPropagation()}
                className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl w-full max-w-xl max-h-[85vh] flex flex-col overflow-hidden border border-slate-200 dark:border-slate-800"
            >
